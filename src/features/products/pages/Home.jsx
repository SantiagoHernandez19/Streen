...
// ELIMINADO: import { initialProducts } from "../../../data";
...
const buildInitialInventoryFromProducts = (products) => {
  ...
  for (const p of products) {
    ...
    // Si la DB tiene tallas con cantidades específicas (tallasStock), usamos eso en lugar de dividir
...
const Home = ({ updateCart, cartItems }) => {
  ...
  const [initialProducts, setInitialProducts] = useState([]); // AÑADIDO: Estado para productos reales
        ...
        <div className="gm-info">
          ...
          <div className="gm-actions-row">
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0px', flex: 1 }}>
              {(product.hasDiscount || product.has_discount) && product.precioOferta ? (
                <>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                    <span className="gm-price-actions" style={{ color: '#F5C81B', fontSize: '1.2rem' }}>
                    ...
                    <span style={{ 
                      ...
                      fontSize: '10px', 
                      fontWeight: '800', 
                      backgroundColor: 'rgba(245, 200, 27, 0.15)', 
                      padding: '2px 5px', 
                      borderRadius: '4px',
              ...
              {/* COLORES ELIMINADOS DE AQUÍ POR PETICIÓN */}
            </div>
            <button
  ...
  return (
    <div className="gm-home page-container">
          ...
          <div className="gm-modal" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="gm-modal-right">
              <div className="gm-modal-header-row">
                <div className="gm-modal-title-row" style={{ display: 'flex', alignItems: 'center', gap: '10px', flexWrap: 'wrap', justifyContent: 'flex-start' }}>
                  <h2 className="gm-modal-title" style={{ margin: 0 }}>{selectedProduct.nombre}</h2>
                  <div className="gm-modal-tags-inline" style={{ marginTop: '0', display: 'flex', gap: '6px' }}>
                    {selectedProduct.colores && selectedProduct.colores.map((color, idx) => (
                      <span 
                        key={idx} 
                        style={{
                          ...
                          boxShadow: `0 0 10px ${color}22` // Un leve brillo del color
                        }}
                      >
                        {color}
                      </span>
                ...
                <div className="gm-price-tags-row" style={{ 
                  display: 'flex', 
                  ...
                  {(selectedProduct.hasDiscount || selectedProduct.has_discount) && selectedProduct.precioOferta ? (
                    <>
                      <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                        <div className="gm-modal-price-below" style={{ fontSize: '1.8rem', color: '#F5C81B', fontWeight: '900' }}>
                          ${Math.round(selectedProduct.precioOferta).toLocaleString()}
                        </div>
                        <span style={{ 
                          color: '#F5C81B', 
                          fontSize: '11px', 
                          ...
                          padding: '4px 10px', 
                          borderRadius: '4px',
                          border: '1px solid rgba(245, 200, 27, 0.2)'
                        }}>
                          {Math.round(((selectedProduct.precio - selectedProduct.precioOferta) / selectedProduct.precio) * 100)}% DCTO
                        </span>
                      </div>
                      <div style={{ 
                        color: '#6B7280', 
                        ...
                        Antes: ${Math.round(selectedProduct.precio || 0).toLocaleString()}
                      </div>
                    </>
                  ) : (
                    <div className="gm-modal-price-below" style={{ fontSize: '1.8rem', fontWeight: '900' }}>
      ...
      <style>{`
        ...
        .gm-card {
          background: #111827; /* Un gris azulado oscuro un poco más claro que el negro */
          border: none;
          border-radius: 20px;
          overflow: hidden;
        ...
        .gm-card:hover {
          background: #1f2937;
          transform: scale(1.05); /* Zoom uniforme hacia el frente */
        ...
        .gm-img-wrapper {
          ...
          position: relative;
          overflow: hidden;
          border-radius: 0; /* Imagen cuadrada como pediste */
          background: #000;
