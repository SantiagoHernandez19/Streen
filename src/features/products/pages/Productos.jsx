...
const Productos = ({ addToCart }) => {
  ...
  const [initialProducts, setInitialProducts] = useState([]); // ✅ Estado para los productos de la nube
  ...
  const productsByCategory = useMemo(() => {
    ...
    return grouped;
  }, [initialProducts]); // ✅ Agregado initialProducts a dependencias para que recalcule al llegar BD
